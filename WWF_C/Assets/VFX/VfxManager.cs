...
public class VfxManager : MonoBehaviour {
    ...
    public void PlayEffect(VisualEffects.VfxEnum vfxEnum, Transform origin, Vector3 position, Vector3 dir_forward, bool attachedToOrigin) {
        //GameObject vfxGameObject = Instantiate(VisualEffects.i.effects[vfxEnum], transform);
        ...
        vfxGameObject.transform.forward = dir_forward;
